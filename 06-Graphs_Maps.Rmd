...
tp2 = plot_indices(indices = indices,
 ...
 # pdf(file = "Scarlet Tanager Trajectories plus.pdf")
 # print(tp)
 # dev.off()
...
tp3 = plot_indices(indices = indices_smooth,
                  ...
                  add_observed_means = TRUE,
                  add_number_routes = TRUE)
 # pdf(file = "Scarlet Tanager Trajectories smooth plus.pdf")
 # print(tp)
 # dev.off()
...
``` {r GM7}
  ...
  #png("SCTA_geofacet.png",width = 1500, height = 750,res = 150)
  print(gf)
  #dev.off()
```
